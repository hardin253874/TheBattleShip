...
namespace TheBattleShip
{
    class ControlOutput
    {
        ...
        public static void ShowFlashScreen()
        {
            ...
            Console.WriteLine("        ********************************************");
            Console.Write("        *"); Console.ForegroundColor = ConsoleColor.White; Console.Write("    Welcome to The Flare Battleship Game!!!     "); Console.ForegroundColor = ConsoleColor.Green; Console.WriteLine("*");
            Console.WriteLine("        ********************************************");
        ...
        public static void ShowHeader()
        {
            ...
            Console.Write("       THE FLARE BATTLESHIP GAME!!!     "); Console.ForegroundColor = ConsoleColor.Green; Console.WriteLine("*");
            Console.WriteLine("        ************************************");
            Console.WriteLine("");
            Console.ForegroundColor = ConsoleColor.White;
        }
